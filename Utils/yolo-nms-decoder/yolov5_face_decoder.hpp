...
class YoloFaceDecoder {
    ...
    void extract_boxes( std::vector<T> &fm, YoloFaceQunatizationInfo &q_info, int feature_map_size_row, int feature_map_size_col, 
...
public:
    ...
    virtual YoloFaceDecodedBox box_decode(  std::vector<T> &fm, int fm_offset, 
...
public:
    ...
    //Override parent
    YoloFaceDecodedBox box_decode(  std::vector<T> &fm, int fm_offset, 
                            std::vector<int> &Anchors, int anchor_index, YoloFaceQunatizationInfo &q_info,
